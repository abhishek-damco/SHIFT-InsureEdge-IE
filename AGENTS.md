# SHIFT AI Modernization Platform — Codex Configuration

This workspace contains the SHIFT platform and project instances. Codex agents are mapped below.
...
4. In Codex, invoke the Chief Orchestrator (see below)

---

## Agent Definitions (@-mentions)

Codex agents are defined here so they can be invoked with `@agent-name`.
