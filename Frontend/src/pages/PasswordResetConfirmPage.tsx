// US-015/US-017: Confirm password reset
// Reads username + token from URL params; validates token (3-check) before showing form.
// CORRECTIVE (DBT-SEC-004): validate endpoint checks exists + not-expired + hash-matches.
